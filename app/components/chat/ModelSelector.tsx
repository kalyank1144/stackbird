...
export const ModelSelector = ({
  ...
  if (providerList.length === 0) {
    return (
      <div className="mb-2 p-4 rounded-xl border border-gray-200/50 dark:border-slate-700/50 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm text-gray-700 dark:text-gray-300">
      ...
      <div className="relative flex w-full" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <div
          className={classNames(
            'w-full p-2.5 rounded-xl border border-gray-200/50 dark:border-slate-700/50',
            'bg-gray-50/50 dark:bg-slate-800/50 text-gray-700 dark:text-gray-300',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500/30',
            'transition-all cursor-pointer hover:bg-gray-100/50 dark:hover:bg-slate-700/50',
            isProviderDropdownOpen ? 'ring-2 ring-blue-500/30 border-blue-500/50' : undefined,
          )}
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div
              className={classNames(
                'i-ph:caret-down w-4 h-4 text-gray-400 dark:text-gray-500 transition-transform',
        ...
        {isProviderDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-xl border border-gray-200/50 dark:border-slate-700/50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-xl"
            role="listbox"
            id="provider-listbox"
          >
              ...
              <div className="relative">
                <input
                  ...
                  className={classNames(
                    ...
                    'bg-gray-50 dark:bg-slate-800 border border-gray-200/50 dark:border-slate-700/50',
                ...
                <div className="absolute left-2.5 top-1/2 -translate-y-1/2">
                  <span className="i-ph:magnifying-glass text-gray-400 dark:text-gray-500" />
                </div>
                {providerSearchQuery && (
                  <button
                    type="button"
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 p-0.5 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-colors"
                    aria-label="Clear search"
                  >
                    <span className="i-ph:x text-gray-400 dark:text-gray-500 text-xs" />
                  </button>
                )}
              </div>
            </div>
            ...
            <div
              className={classNames(
                ...
                '[&::-webkit-scrollbar-thumb]:hover:bg-gray-400 dark:[&::-webkit-scrollbar-thumb]:hover:bg-slate-500',
              ...
              {filteredProviders.length === 0 ? (
                ...
                filteredProviders.map((providerOption, index) => (
                  <div
                    ...
                    className={classNames(
                      'px-3 py-2 text-sm cursor-pointer rounded-lg mx-1',
                      ...
                      provider?.name === providerOption.name || focusedProviderIndex === index
                        ...
                        : undefined,
                      focusedProviderIndex === index ? 'ring-1 ring-inset ring-blue-500/50' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <div
          className={classNames(
            ...
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-blue-500/30',
            'transition-all cursor-pointer hover:bg-gray-100/50 dark:hover:bg-slate-700/50',
            isModelDropdownOpen ? 'ring-2 ring-blue-500/30 border-blue-500/50' : undefined,
          )}
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-10 w-full mt-1 py-1 rounded-xl border border-gray-200/50 dark:border-slate-700/50 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl shadow-xl"
            role="listbox"
            id="model-listbox"
          >
                  ...
                  <button
                    ...
                    className={classNames(
                      ...
                      showFreeModelsOnly
                        ...
                        : 'bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-gray-400 border border-gray-200/50 dark:border-slate-700/50',
                    )}
                  >
              ...
              {modelLoading === 'all' || modelLoading === provider?.name ? (
                <div className="px-3 py-3 text-sm">
                  <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
                    <span className="i-ph:spinner animate-spin text-blue-500" />
                    Loading models...
                  </div>
                </div>
                  ...
                  <div
                    ...
                    className={classNames(
                      ...
                      model === modelOption.name || focusedModelIndex === index
                        ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400'
                        : undefined,
                      focusedModelIndex === index ? 'ring-1 ring-inset ring-blue-500/50' : undefined,
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-1 ml-2">
                        {isModelLikelyFree(modelOption, provider?.name) && (
                          <span className="i-ph:gift text-xs text-blue-500" title="Free model" />
                        )}
                        {model === modelOption.name && (
                          <span className="i-ph:check text-xs text-blue-500" title="Selected" />
                        )}
                      </div>
                    </div>
                  </div>
