...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
  ...
  return (
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-2 flex items-center gap-2 border-b border-gray-100/50 dark:border-slate-800/50">
        <div className="flex items-center gap-1">
          <IconButton icon="i-ph:arrow-clockwise" onClick={reloadPreview} />
          <IconButton
            icon="i-ph:selection"
            onClick={() => setIsSelectionMode(!isSelectionMode)}
            className={isSelectionMode ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : ''}
          />
        </div>

        <div className="flex-grow flex items-center gap-1 bg-gray-50 dark:bg-slate-800 border border-gray-200/50 dark:border-slate-700/50 text-gray-600 dark:text-gray-400 rounded-xl px-2 py-1.5 text-sm hover:bg-gray-100 dark:hover:bg-slate-700 focus-within:bg-white dark:focus-within:bg-slate-900 focus-within:border-blue-500/50 focus-within:ring-2 focus-within:ring-blue-500/20 transition-all">
          <PortDropdown
        ...
        <div className="flex items-center gap-2">
          ...
          <IconButton
            ...
            className={isInspectorMode ? 'bg-blue-50 dark:bg-blue-900/30 !text-blue-500' : ''}
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-white dark:bg-black rounded-xl shadow-2xl border border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)] overflow-hidden">
                  <div className="p-3 border-b border-[#E5E7EB] dark:border-[rgba(255,255,255,0.1)]">
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        className={`flex w-full justify-between items-center text-start bg-transparent text-xs text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400`}
                        onClick={() => {
                          openInNewTab();
                        }}
                      >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500 dark:text-gray-400">Show Device Frame</span>
                        <button
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-500 dark:text-gray-400">Landscape Mode</span>
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
      ...
      <div className="flex-1 border-t border-gray-200/50 dark:border-slate-700/50 flex justify-center items-center overflow-auto">
        <div
          style={{
        ...
        >
          {activePreview ? (
            <>
              {isDeviceModeOn && showDeviceFrameInPreview ? (
                ...
                <iframe
                  ref={iframeRef}
                  title="preview"
                  className="border-none w-full h-full bg-white dark:bg-slate-900"
                  src={iframeUrl}
                  sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin"
            ...
            <div className="flex w-full h-full justify-center items-center bg-white dark:bg-slate-900 text-gray-700 dark:text-gray-300">
