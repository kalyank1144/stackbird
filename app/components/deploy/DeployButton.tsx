...
export const DeployButton = ({
  ...
  return (
    <>
      <div className="flex rounded-xl overflow-hidden text-sm shadow-sm">
        <DropdownMenu.Root>
          <DropdownMenu.Trigger
            disabled={isDeploying || !activePreview || isStreaming}
            className="rounded-xl items-center justify-center [&:is(:disabled,.disabled)]:cursor-not-allowed [&:is(:disabled,.disabled)]:opacity-60 px-4 py-2 text-xs bg-gradient-to-r from-blue-500 to-purple-500 text-white hover:from-blue-600 hover:to-purple-600 flex gap-2 transition-all shadow-md hover:shadow-lg"
          >
          ...
          >
            <DropdownMenu.Item
              className={classNames(
                'cursor-pointer flex items-center w-full px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-blue-900/30 gap-3 rounded-xl group relative transition-colors',
                {
            ...
            <DropdownMenu.Item
              disabled
              className="flex items-center w-full rounded-xl px-4 py-2.5 text-sm text-gray-400 dark:text-gray-500 gap-3 opacity-60 cursor-not-allowed"
            >
              <img
                className="w-5 h-5"
                height="24"
