 ...
 * Note: These are safe defaults - most Claude models have 4096-8192 max output
 */
export const PROVIDER_COMPLETION_LIMITS: Record<string, number> = {
  ...
  Anthropic: 4096, // Safe default for Claude models (legacy Haiku: 4096, 3.5 models: 8192)
